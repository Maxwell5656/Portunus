/*//GEN-FIRST:event_UNCopyBtnActionPerformed
 * To change this license header, choose License Headers in Project Properties.//GEN-LAST:event_UNCopyBtnActionPerformed
...
public class Interface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ExistingAccountPnlLayout.setHorizontalGroup(
            ...
            .addGroup(ExistingAccountPnlLayout.createSequentialGroup()
                        ...
                        .addGroup(ExistingAccountPnlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(ExistingAccountPnlLayout.createSequentialGroup()
                                .addGroup(ExistingAccountPnlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(AccUNField, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                                .addGap(48, 48, 48)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(ExistingAccountPnlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(PWCopyBtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(SQCopyBtn1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void PasswordsBtnActionPerformed(java.awt.event.ActionEvent evt) {                                             
    ...
    private void LoginPgBtnActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    private void LoginOutBtnActionPerformed(java.awt.event.ActionEvent evt) {                                            
        LoginScreen.setVisible(true);
        NavigationScreen.setVisible(false);
        NewAccountScreen.setVisible(false);
    }                                           

    private void CreateUserAccBtnActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        NavigationScreen.setVisible(true);
        LoginScreen.setVisible(false);
        NewAccountScreen.setVisible(false);
    }                                                

    private void CreateNewAccBtnActionPerformed(java.awt.event.ActionEvent evt) {                                                
        NewAccountScreen.setVisible(true);
        NavigationScreen.setVisible(false);
        LoginScreen.setVisible(false);
    }                                               

    private void SettingsDoneBtnActionPerformed(java.awt.event.ActionEvent evt) {                                                
    ...
    private void ShowAccBtnActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    private void UNCopyBtnActionPerformed(java.awt.event.ActionEvent evt) {                                          
        CopyInfo copier = new CopyInfo();
        copier.copy(AccUNField.getText());
    }                                         

    private void PWCopyBtnActionPerformed(java.awt.event.ActionEvent evt) {                                          
        CopyInfo copier = new CopyInfo();
        copier.copy(AccPWField.getText());
    }                                         

    private void SQCopyBtn1ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        CopyInfo copier = new CopyInfo();
        copier.copy(AccSQAnswerField1.getText());
    }                                          

    private void SQCopyBtn2ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        CopyInfo copier = new CopyInfo();
        copier.copy(AccSQAnswerField2.getText());
    }                                          

    private void SQCopyBtn3ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        CopyInfo copier = new CopyInfo();
        copier.copy(AccSQAnswerField3.getText());
    }                                          

    private void AddNewAccBtnActionPerformed(java.awt.event.ActionEvent evt) {                                             
        NewAccountPnl.setVisible(true);
        ExistingAccountPnl.setVisible(false);
    }                                            

    private void DeleteAccBtnActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
        NewAccountPnl.setVisible(true);
        ExistingAccountPnl.setVisible(false);
        this.deleter.delete(this.AccountList.getSelectedValue().getIdent());
    }                                                                                      
    private void EditAccBtnActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
